...
def main():
    ...
    train_loader = load_train_data(site_name, dataset_name='svhn', batch_size=nubatch_size, num_clients=10, alpha=0.5, skew_type="quantity")
    val_loader = load_val_data(site_name, dataset_name='svhn', batch_size=nubatch_size)
