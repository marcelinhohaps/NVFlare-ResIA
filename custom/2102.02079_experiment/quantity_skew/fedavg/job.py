...
def main():
    ...
    recipe = FedAvgRecipe(
        name="adult_fedavg_quantity-skew",
        min_clients=args.n_clients,
        num_rounds=args.num_rounds,
        initial_model=initial_model,
        train_script="/home/marcelohaps/NVFlare-ResIA/custom/client.py",
    )
    ...
    tracking_config={
        "mode": "online", 
        "wandb_args": {
            "project": "ADULT_FEDAVG_QUANTITY-SKEW",
            "group": "ADULT_FEDAVG_QUANTITY-SKEW",
            "job_type": "train",
            "name": "adult-fedavg",  
            "notes": "experimento base",
            "tags": ["adult", "fedavg", "quantity-skew"],
    ...
    if args.mode == "simulator":
        ...
        env = SimEnv(
            ...
            workspace_root="/home/marcelohaps/NVFlare-ResIA/custom/workspace_adult"
        )
        ...
        poc_path = "/tmp/nvflare/poc/adult_fedavg_quantity-skew"
