...
def main():
    ...
    train_loader = load_train_data(site_name, dataset_name='cifar10', batch_size=nubatch_size, num_clients=10, alpha=0.5, skew_type="quantity")
    val_loader = load_val_data(site_name, dataset_name='cifar10', batch_size=nubatch_size)
